...
@section('content')
    <div class="d-flex justify-content-between align-items-center">
        <h1>@yield('title')</h1>
        <a href="{{ route('admin.property.create') }}" class="btn btn-outline-success border-0 rounded-start-pill">
                ...
                <td>
                    ...
                    <div class="d-flex gap-2 w-100 justify-content-end">
                        @if($property->deleted_at !== null)
                            <form action="{{ route('admin.property.delete', $property) }}" method="post">
                                @csrf
                                @method("delete")
                            ...
                            <from action="{{ route('admin.property.restore', $property) }}" method="post">
                                @csrf
                                @method("put")
                        ...
                        @endif
                        <a href="{{ route('admin.property.edit', $property) }}" class="btn btn-outline-primary border-0 rounded-2">
                        ...
                        <form action="{{ route('admin.property.destroy', $property) }}" method="post">
                            @csrf
                            @method("delete")
                            <button class="btn btn-outline-danger border-0 rounded-2">
